...
const allowedPatterns = [
  ...
  /\b(noise|quiet|wifi|wi-fi|internet|remote work|hill|steep|clean|comfort|location|attraction|restaurant|park|museum|viewpoint)\b/i,
...
function outOfScope(reason: string): ScopeDecision {
  return {
    ...
    reason,
    safeResponse:
      "I don't know how to complete that request with my allowed tools. I can only work on the selected Lisbon Airbnb demo listing page: evidence-backed description edits, guest-expectation notes, nearby highlights, restore-to-original, and audit logging. No LLM, RAG, Google Places, or page edit was used for this out-of-scope request."
  };
}
